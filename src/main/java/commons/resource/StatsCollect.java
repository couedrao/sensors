...
@XmlType(name = "", propOrder = { "creator", "statsCollectID",
		"collectingEntityID", "collectedEntityID", "statsRuleStatus",
		"statModel", "collectPeriod", "eventID", "childResource",
		"subscription" })
@XmlRootElement(name = "statsCollect")
public class StatsCollect extends RegularResource {
